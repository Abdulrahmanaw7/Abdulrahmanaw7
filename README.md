...
- 🐳 Preparing and running services on **Docker & Kubernetes**, with CI/CD via **Azure DevOps**.
- 🧠 I use AI-assisted tools (GitHub Copilot, Cursor, prompt engineering) to speed up delivery without cutting corners on architecture.
- 🌍 Previously delivered large-scale platforms in **fintech, government/municipal, and enterprise** domains (Egypt & Saudi Arabia).
